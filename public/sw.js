const CACHE_NAME = "drop-static-v1";
const APP_SHELL = ["/", "/manifest.webmanifest", "/favicon.ico", "/pwa-192.png", "/pwa-512.png"];
const PRIVATE_PATHS = ["/api/", "/checkout", "/pagamento", "/conta", "/admin", "/entrar"];
